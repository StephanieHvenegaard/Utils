    ...
    public partial class CheckListItem : Control, IEquatable<CheckListItem>
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            if (_ShowDecription)
            {
                ...
                if (_Selected)
                {
                    TextRenderer.DrawText(e.Graphics, _Description, this.Font, _DescriptionTextRectangle, SystemColors.Highlight, this.BackColor,
                            TextFormatFlags.Left |
                            TextFormatFlags.VerticalCenter |
                ...
                {
                    TextRenderer.DrawText(e.Graphics, _Description, this.Font, _DescriptionTextRectangle, this.ForeColor, this.BackColor,
                            TextFormatFlags.Left |
                            TextFormatFlags.VerticalCenter |
                                            //TextFormatFlags.Internal |
                            TextFormatFlags.WordBreak |
